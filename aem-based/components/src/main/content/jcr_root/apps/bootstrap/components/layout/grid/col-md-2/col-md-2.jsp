<%@include file="/apps/foundation/global.jsp"%>
    <cq:include path="start" resourceType="bootstrap/components/layout/grid/col-md-2/start"/>
    ...
    <cq:include path="end" resourceType="bootstrap/components/layout/grid/col-md-2/end"/>
<script>
